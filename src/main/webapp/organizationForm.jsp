    ...
    <form id="orgForm" action="SaveOrganization">
        <div class="row">
			...
			<div class="col-xs-2">
				...
				<input type="text" class="form-control" id="organization.company" name="company" placeholder="Company" value="<%= organization.getCompany() %>">
            </div>
           ...
           <div class="col-xs-2">
				...
				%>
				<option value="<%=inds[i].getMsg().trim()%>" <% if(organization.getIndustry().getMsg().trim().equals(inds[i].getMsg().trim())) {  %>selected<% } %>><%=inds[i].getMsg()%>
				</option> <%
 				}
     			%>
				</select>
        ...
        <div class="row">
           ...
           <div class="col-xs-2">
				...
				<select name='ownerShip'>  <option value="none">Select</option>  
				<% 
				OwnerShip ownerships[] = OwnerShip.values(); 
				for(int i=0;i<ownerships.length;i++){
				%>
				<option value="<%=ownerships[i].getMsg().trim()%>" <% if(organization.getOwnerShip().getMsg().trim().equals(ownerships[i].getMsg().trim())) {  %>selected<% } %>><%=ownerships[i].getMsg()%>
				</option> <%
 				}
     			%>
				</select>
        ...
        <div class="row">
			<div class="col-xs-2">
				...
				<input type="text" class="form-control" id="organization.mobile" name="mobile" placeholder="Mobile" value="<%= organization.getMobile() %>">
            </div>
           
			<div class="col-xs-2">
                <label for="organization.website" class="control-label" style="font-weight: normal;">Website</label>
				<input type="url" class="form-control" placeholder="Website" name="website" value="<%= organization.getWebsite() %>">
            </div>
           <div class="col-xs-2">
                <label for="organization.fax" class="control-label" style="font-weight: normal;">Fax</label>
				<input type="text" class="form-control" placeholder="Fax" id = "organization.fax" name="fax" value="<%= organization.getFax() %>">
            </div>
        ...
        <div class="row">
			<div class="col-xs-2">
				...
				<input type="text" class="form-control" id="organization.noOfEmployers" name="noOfEmployers" placeholder="No.Employers" value="<%= organization.getNumOfEmployers() %>">
            </div>
            ...
            <div class="col-xs-2">
				...
				%>
				<option value="<%=ratings[i].getMsg().trim()%>" <% if(organization.getRating().getMsg().trim().equals(ratings[i].getMsg().trim())) {  %>selected<% } %>><%=ratings[i].getMsg()%>
				</option> <%
 				}
     			%>
				</select>
			...
			<div class="col-xs-2">
				...
				<select name='organizationType'>  <option value="none">Select</option>  
				<% 
				OrganizationType oTypes[] = OrganizationType.values(); 
				for(int i=0;i<oTypes.length;i++){
				%>
				<option value="<%=oTypes[i].getMsg().trim()%>" <% if(organization.getOrganizationType().getMsg().trim().equals(oTypes[i].getMsg().trim())) {  %>selected<% } %>><%=oTypes[i].getMsg()%>
				</option> <%
 				}
     			%>
				</select>
        ...
        <div class="row">
			...
			<div class="col-xs-2">
				...
				<select name='revenueRange'>  <option value="none">Select</option>  
				<% 
				RevenueRange ranges[] = RevenueRange.values(); 
				for(int i=0;i<ranges.length;i++){
				%>
				<option value="<%=ranges[i].getMsg().trim()%>" <% if(organization.getRevenueRange().getMsg().trim().equals(ranges[i].getMsg().trim())) {  %>selected<% } %>><%=ranges[i].getMsg()%>
				</option> <%
 				}
     			%>
				</select>
	...
	<u><ul>Address<ul></u>
		...
		<div class="row">
			<div class="col-xs-2">
				...
				<input type="text" class="form-control" id="organization.city" name="city" placeholder="City" value="<%= organization.getAddress().getCity() %>"	>
            </div>
           
			<div class="col-xs-2">
                <label for="street" class="control-label" style="font-weight: normal;">Street</label>
				<input type="text" class="form-control" placeholder="Street" name="street" value="<%= organization.getAddress().getStreet() %>">
            </div>
           <div class="col-xs-2">
                <label for="building" class="control-label" style="font-weight: normal;" style="font-weight: normal;">Building</label>
				<input type="text" class="form-control" placeholder="Building" name="building" value="<%= organization.getAddress().getBldg() %>">
            </div>
		...
		<div class="row">
			<div class="col-xs-2">
				...
				<input type="text" class="form-control" id="officeNumber" name="officeNumber" placeholder="Off or Res No" value="<%= organization.getAddress().getOfficeNumber() %>">
             </div>
           
			<div class="col-xs-2">
                <label for="zip" class="control-label" style="font-weight: normal;">Zip</label>
				<input type="text" class="form-control" placeholder="Zip or Pin" name="zip" value="<%= organization.getAddress().getPin() %>">
            </div>
           <div class="col-xs-2">
				...
				%>
				<option value="<%=states[i].getMsg().trim()%>" <% if(organization.getAddress().getState().getMsg().trim().equals(states[i].getMsg().trim())) {  %>selected<% } %>><%=states[i].getMsg()%>
				</option> <%
 				}
     			%>
				</select>
		...
		<div class="row">
			<div class="col-xs-2">
				...
				<input type="text" class="form-control" id="country" placeholder="Country" name="country" value="<%= organization.getAddress().getCountry() %>">
            </div>
